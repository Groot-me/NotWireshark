...
class Trame:
    ...
    def Frame_Header(self, Data):
        ...
        elif (EtherType == "0x86dd"):  # Does not yet support IPv6 protocol
            print(f"{White} | Protocol : {Ox86dd} Not yet Implemented {Reset}", end="")
